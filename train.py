...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--testing_data", type=str, default="visa", help="Dataset for testing (default: 'visa')"
    )
    ...
    parser.add_argument(
        "--ckt_path", type=str, default="", help="Path to the pre-trained model (default: '')"
    )

    # Hyper-parameters
    parser.add_argument(
        "--exp_indx", type=int, default=0, help="Index of the experiment (default: 0)"
    )
    ...
    parser.add_argument(
        "--image_size", type=int, default=518, help="Size of the input images (default: 518)"
    )
    parser.add_argument(
        "--print_freq", type=int, default=1, help="Frequency of print statements (default: 1)"
    )
    parser.add_argument(
        "--valid_freq", type=int, default=1, help="Frequency of validation (default: 1)"
    )
    ...
    parser.add_argument(
        "--prompting_length", type=int, default=5, help="Length of prompting (default: 5)"
    )
    parser.add_argument(
        "--prompting_type",
        type=str,
