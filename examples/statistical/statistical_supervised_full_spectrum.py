...
It:
  ...
  * Uses LentilsAnomalyDataNode → SupervisedFullSpectrumSelector → AdaCLIPDetector.
...
def main(**kwargs) -> None:
    ...
    band_selector = SupervisedFullSpectrumSelector(
    ...
    pipeline_metadata = PipelineMetadata(
        ...
        description=(
            ...
            "(LentilsAnomalyDataNode → SupervisedFullSpectrumSelector → AdaCLIPDetector)"
        ),
